...
const ShelfAppearance$json = const {
  ...
  '2': const [
    ...
    const {'1': 'SHELF_APPEARANCE_KACHAKA_BASE', '2': 8},
  ],
};

/// Descriptor for `ShelfAppearance`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List shelfAppearanceDescriptor = $convert.base64Decode('');
...
const GetBackCameraRosCameraInfoResponse$json = const {
...
final $typed_data.Uint8List getBackCameraRosCameraInfoResponseDescriptor = $convert.base64Decode('CiJHZXRCYWNrQ2FtZXJhUm9zQ2FtZXJhSW5mb1Jlc3BvbnNlEjEKCG1ldGFkYXRhGAEgASgLMhUua2FjaGFrYV9hcGkuTWV0YWRhdGFSCG1ldGFkYXRhEjsKC2NhbWVyYV9pbmZvGAIgASgLMhoua2FjaGFrYV9hcGkuUm9zQ2FtZXJhSW5mb1IKY2FtZXJhSW5mbw==');
@$core.Deprecated('Use getBackCameraRosImageResponseDescriptor instead')
const GetBackCameraRosImageResponse$json = const {
...
final $typed_data.Uint8List getBackCameraRosImageResponseDescriptor = $convert.base64Decode('Ch1HZXRCYWNrQ2FtZXJhUm9zSW1hZ2VSZXNwb25zZRIxCghtZXRhZGF0YRgBIAEoCzIVLmthY2hha2FfYXBpLk1ldGFkYXRhUghtZXRhZGF0YRIrCgVpbWFnZRgCIAEoCzIVLmthY2hha2FfYXBpLlJvc0ltYWdlUgVpbWFnZQ==');
@$core.Deprecated('Use getBackCameraRosCompressedImageResponseDescriptor instead')
const GetBackCameraRosCompressedImageResponse$json = const {
...
final $typed_data.Uint8List getBackCameraRosCompressedImageResponseDescriptor = $convert.base64Decode('CidHZXRCYWNrQ2FtZXJhUm9zQ29tcHJlc3NlZEltYWdlUmVzcG9uc2USMQoIbWV0YWRhdGEYASABKAsyFS5rYWNoYWthX2FwaS5NZXRhZGF0YVIIbWV0YWRhdGESNQoFaW1hZ2UYAiABKAsyHy5rYWNoYWthX2FwaS5Sb3NDb21wcmVzc2VkSW1hZ2VSBWltYWdl');
...
const GetCommandStateResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'command_id', '3': 4, '4': 1, '5': 9, '10': 'commandId'},
  ],
};

/// Descriptor for `GetCommandStateResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getCommandStateResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getLastCommandResultResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List mapListEntryDescriptor = $convert.base64Decode('CgxNYXBMaXN0RW50cnkSDgoCaWQYAiABKAlSAmlkEhIKBG5hbWUYASABKAlSBG5hbWU=');
@$core.Deprecated('Use getMapListResponseDescriptor instead')
const GetMapListResponse$json = const {
  '1': 'GetMapListResponse',
  '2': const [
    const {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.kachaka_api.Metadata', '10': 'metadata'},
    const {'1': 'map_list_entries', '3': 2, '4': 3, '5': 11, '6': '.kachaka_api.MapListEntry', '10': 'mapListEntries'},
  ],
};

/// Descriptor for `GetMapListResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMapListResponseDescriptor = $convert.base64Decode('ChJHZXRNYXBMaXN0UmVzcG9uc2USMQoIbWV0YWRhdGEYASABKAsyFS5rYWNoYWthX2FwaS5NZXRhZGF0YVIIbWV0YWRhdGESQwoQbWFwX2xpc3RfZW50cmllcxgCIAMoCzIZLmthY2hha2FfYXBpLk1hcExpc3RFbnRyeVIObWFwTGlzdEVudHJpZXM=');
@$core.Deprecated('Use getCurrentMapIdResponseDescriptor instead')
const GetCurrentMapIdResponse$json = const {
...
final $typed_data.Uint8List getCurrentMapIdResponseDescriptor = $convert.base64Decode('ChdHZXRDdXJyZW50TWFwSWRSZXNwb25zZRIxCghtZXRhZGF0YRgBIAEoCzIVLmthY2hha2FfYXBpLk1ldGFkYXRhUghtZXRhZGF0YRIOCgJpZBgCIAEoCVICaWQ=');
@$core.Deprecated('Use loadMapPreviewRequestDescriptor instead')
const LoadMapPreviewRequest$json = const {
  '1': 'LoadMapPreviewRequest',
  '2': const [
    const {'1': 'map_id', '3': 1, '4': 1, '5': 9, '10': 'mapId'},
  ],
};

/// Descriptor for `LoadMapPreviewRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List loadMapPreviewRequestDescriptor = $convert.base64Decode('ChVMb2FkTWFwUHJldmlld1JlcXVlc3QSFQoGbWFwX2lkGAEgASgJUgVtYXBJZA==');
@$core.Deprecated('Use loadMapPreviewResponseDescriptor instead')
const LoadMapPreviewResponse$json = const {
...
final $typed_data.Uint8List loadMapPreviewResponseDescriptor = $convert.base64Decode('ChZMb2FkTWFwUHJldmlld1Jlc3BvbnNlEisKBnJlc3VsdBgBIAEoCzITLmthY2hha2FfYXBpLlJlc3VsdFIGcmVzdWx0EiIKA21hcBgCIAEoCzIQLmthY2hha2FfYXBpLk1hcFIDbWFw');
@$core.Deprecated('Use exportMapRequestDescriptor instead')
const ExportMapRequest$json = const {
  '1': 'ExportMapRequest',
  '2': const [
    const {'1': 'map_id', '3': 1, '4': 1, '5': 9, '10': 'mapId'},
  ],
...
final $typed_data.Uint8List exportMapRequestDescriptor = $convert.base64Decode('ChBFeHBvcnRNYXBSZXF1ZXN0EhUKBm1hcF9pZBgBIAEoCVIFbWFwSWQ=');
@$core.Deprecated('Use exportMapResponseDescriptor instead')
const ExportMapResponse$json = const {
  '1': 'ExportMapResponse',
  '2': const [
    const {'1': 'middle_of_stream', '3': 1, '4': 1, '5': 11, '6': '.kachaka_api.ExportMapResponse.MiddleOfStream', '9': 0, '10': 'middleOfStream'},
    const {'1': 'end_of_stream', '3': 2, '4': 1, '5': 11, '6': '.kachaka_api.ExportMapResponse.EndOfStream', '9': 0, '10': 'endOfStream'},
  ],
  '3': const [ExportMapResponse_MiddleOfStream$json, ExportMapResponse_EndOfStream$json],
  '8': const [
    const {'1': 'response'},
  ],
};
...
@$core.Deprecated('Use exportMapResponseDescriptor instead')
const ExportMapResponse_MiddleOfStream$json = const {
  '1': 'MiddleOfStream',
  '2': const [
    const {'1': 'data', '3': 1, '4': 1, '5': 12, '10': 'data'},
  ],
...
@$core.Deprecated('Use exportMapResponseDescriptor instead')
const ExportMapResponse_EndOfStream$json = const {
  '1': 'EndOfStream',
  '2': const [
    const {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.kachaka_api.Result', '10': 'result'},
  ],
...
final $typed_data.Uint8List exportMapResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use importMapRequestDescriptor instead')
const ImportMapRequest$json = const {
  '1': 'ImportMapRequest',
  '2': const [
    const {'1': 'data', '3': 1, '4': 1, '5': 12, '10': 'data'},
  ],
...
final $typed_data.Uint8List importMapRequestDescriptor = $convert.base64Decode('ChBJbXBvcnRNYXBSZXF1ZXN0EhIKBGRhdGEYASABKAxSBGRhdGE=');
@$core.Deprecated('Use importMapResponseDescriptor instead')
const ImportMapResponse$json = const {
  '1': 'ImportMapResponse',
  '2': const [
    const {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.kachaka_api.Result', '10': 'result'},
    const {'1': 'map_id', '3': 2, '4': 1, '5': 9, '10': 'mapId'},
  ],
};

/// Descriptor for `ImportMapResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List importMapResponseDescriptor = $convert.base64Decode('ChFJbXBvcnRNYXBSZXNwb25zZRIrCgZyZXN1bHQYASABKAsyEy5rYWNoYWthX2FwaS5SZXN1bHRSBnJlc3VsdBIVCgZtYXBfaWQYAiABKAlSBW1hcElk');
