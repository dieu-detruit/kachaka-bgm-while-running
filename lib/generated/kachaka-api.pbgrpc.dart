...
class KachakaApiClient extends $grpc.Client {
  ...
  static final _$getBackCameraRosCameraInfo =
      $grpc.ClientMethod<$0.GetRequest, $0.GetBackCameraRosCameraInfoResponse>(
          '/kachaka_api.KachakaApi/GetBackCameraRosCameraInfo',
          ($0.GetRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.GetBackCameraRosCameraInfoResponse.fromBuffer(value));
  static final _$getBackCameraRosImage =
      $grpc.ClientMethod<$0.GetRequest, $0.GetBackCameraRosImageResponse>(
          '/kachaka_api.KachakaApi/GetBackCameraRosImage',
          ($0.GetRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.GetBackCameraRosImageResponse.fromBuffer(value));
  static final _$getBackCameraRosCompressedImage = $grpc.ClientMethod<
          $0.GetRequest, $0.GetBackCameraRosCompressedImageResponse>(
      '/kachaka_api.KachakaApi/GetBackCameraRosCompressedImage',
      ($0.GetRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.GetBackCameraRosCompressedImageResponse.fromBuffer(value));
  ...
  static final _$getMapList =
      $grpc.ClientMethod<$0.GetRequest, $0.GetMapListResponse>(
          '/kachaka_api.KachakaApi/GetMapList',
          ($0.GetRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.GetMapListResponse.fromBuffer(value));
  static final _$getCurrentMapId =
      $grpc.ClientMethod<$0.GetRequest, $0.GetCurrentMapIdResponse>(
          '/kachaka_api.KachakaApi/GetCurrentMapId',
          ($0.GetRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.GetCurrentMapIdResponse.fromBuffer(value));
  static final _$loadMapPreview =
      $grpc.ClientMethod<$0.LoadMapPreviewRequest, $0.LoadMapPreviewResponse>(
          '/kachaka_api.KachakaApi/LoadMapPreview',
          ($0.LoadMapPreviewRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.LoadMapPreviewResponse.fromBuffer(value));
  static final _$exportMap =
      $grpc.ClientMethod<$0.ExportMapRequest, $0.ExportMapResponse>(
          '/kachaka_api.KachakaApi/ExportMap',
          ($0.ExportMapRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.ExportMapResponse.fromBuffer(value));
  static final _$importMap =
      $grpc.ClientMethod<$0.ImportMapRequest, $0.ImportMapResponse>(
          '/kachaka_api.KachakaApi/ImportMap',
          ($0.ImportMapRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.ImportMapResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetBackCameraRosCameraInfoResponse>
      getBackCameraRosCameraInfo($0.GetRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getBackCameraRosCameraInfo, request,
        options: options);
  }

  $grpc.ResponseFuture<$0.GetBackCameraRosImageResponse> getBackCameraRosImage(
      $0.GetRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getBackCameraRosImage, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetBackCameraRosCompressedImageResponse>
      getBackCameraRosCompressedImage($0.GetRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getBackCameraRosCompressedImage, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$0.GetMapListResponse> getMapList($0.GetRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMapList, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetCurrentMapIdResponse> getCurrentMapId(
      $0.GetRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getCurrentMapId, request, options: options);
  }

  $grpc.ResponseFuture<$0.LoadMapPreviewResponse> loadMapPreview(
      $0.LoadMapPreviewRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$loadMapPreview, request, options: options);
  }

  $grpc.ResponseStream<$0.ExportMapResponse> exportMap(
      $0.ExportMapRequest request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$exportMap, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseFuture<$0.ImportMapResponse> importMap(
      $async.Stream<$0.ImportMapRequest> request,
      {$grpc.CallOptions? options}) {
...
abstract class KachakaApiServiceBase extends $grpc.Service {
  ...
  KachakaApiServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetRequest,
        ...
        ($0.GetFrontCameraRosCompressedImageResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetRequest,
            $0.GetBackCameraRosCameraInfoResponse>(
        'GetBackCameraRosCameraInfo',
        getBackCameraRosCameraInfo_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetRequest.fromBuffer(value),
        ($0.GetBackCameraRosCameraInfoResponse value) =>
            value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.GetRequest, $0.GetBackCameraRosImageResponse>(
    ...
    $addMethod($grpc.ServiceMethod<$0.GetRequest,
            $0.GetBackCameraRosCompressedImageResponse>(
        'GetBackCameraRosCompressedImage',
        getBackCameraRosCompressedImage_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetRequest.fromBuffer(value),
        ($0.GetBackCameraRosCompressedImageResponse value) =>
            value.writeToBuffer()));
    $addMethod(
    ...
    $addMethod($grpc.ServiceMethod<$0.LoadMapPreviewRequest,
            $0.LoadMapPreviewResponse>(
        'LoadMapPreview',
        loadMapPreview_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.LoadMapPreviewRequest.fromBuffer(value),
  ...
  $async.Future<$0.GetBackCameraRosCameraInfoResponse>
      getBackCameraRosCameraInfo_Pre(
          $grpc.ServiceCall call, $async.Future<$0.GetRequest> request) async {
    return getBackCameraRosCameraInfo(call, await request);
  }

  $async.Future<$0.GetBackCameraRosImageResponse> getBackCameraRosImage_Pre(
      $grpc.ServiceCall call, $async.Future<$0.GetRequest> request) async {
    return getBackCameraRosImage(call, await request);
  }

  $async.Future<$0.GetBackCameraRosCompressedImageResponse>
      getBackCameraRosCompressedImage_Pre(
          $grpc.ServiceCall call, $async.Future<$0.GetRequest> request) async {
  ...
  $async.Future<$0.GetMapListResponse> getMapList_Pre(
      $grpc.ServiceCall call, $async.Future<$0.GetRequest> request) async {
    return getMapList(call, await request);
  }

  $async.Future<$0.GetCurrentMapIdResponse> getCurrentMapId_Pre(
      $grpc.ServiceCall call, $async.Future<$0.GetRequest> request) async {
    return getCurrentMapId(call, await request);
  }

  $async.Future<$0.LoadMapPreviewResponse> loadMapPreview_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.LoadMapPreviewRequest> request) async {
    return loadMapPreview(call, await request);
  }

  $async.Stream<$0.ExportMapResponse> exportMap_Pre($grpc.ServiceCall call,
      $async.Future<$0.ExportMapRequest> request) async* {
  ...
  $async.Future<$0.GetFrontCameraRosCompressedImageResponse>
      getFrontCameraRosCompressedImage(
          $grpc.ServiceCall call, $0.GetRequest request);
  $async.Future<$0.GetBackCameraRosCameraInfoResponse>
      getBackCameraRosCameraInfo($grpc.ServiceCall call, $0.GetRequest request);
  $async.Future<$0.GetBackCameraRosImageResponse> getBackCameraRosImage(
      $grpc.ServiceCall call, $0.GetRequest request);
  $async.Future<$0.GetBackCameraRosCompressedImageResponse>
      getBackCameraRosCompressedImage(
          $grpc.ServiceCall call, $0.GetRequest request);
  ...
  $async.Future<$0.GetMapListResponse> getMapList(
      $grpc.ServiceCall call, $0.GetRequest request);
  $async.Future<$0.GetCurrentMapIdResponse> getCurrentMapId(
      $grpc.ServiceCall call, $0.GetRequest request);
  $async.Future<$0.LoadMapPreviewResponse> loadMapPreview(
      $grpc.ServiceCall call, $0.LoadMapPreviewRequest request);
  $async.Stream<$0.ExportMapResponse> exportMap(
      $grpc.ServiceCall call, $0.ExportMapRequest request);
  $async.Future<$0.ImportMapResponse> importMap(
      $grpc.ServiceCall call, $async.Stream<$0.ImportMapRequest> request);
